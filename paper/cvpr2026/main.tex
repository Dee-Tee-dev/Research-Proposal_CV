...
Automatic caption recall was higher in Q4 than Q1 for every caption condition. The gaps were 47.6 points for unprompted BLIP, 52.4 for prompted BLIP, 45.2 for Qwen, and 21.4 for InternVL. Manual review gave a different view of BLIP. Object correctness was 80.4\% without the prompt and 83.9\% with it, compared with automatic recall of 53.0\% and 51.2\%. The prompt reduced automatic recall by 1.8 points, but improved human-rated correctness by 3.6 points and reduced hallucinations from 16.7\% to 12.5\%. Agreement was 89.3\% ($\kappa=0.65$) for object correctness and 94.0\% ($\kappa=0.77$) for hallucination. The term list missed reasonable descriptions such as \emph{bucket} or \emph{basket} for a trash container.
